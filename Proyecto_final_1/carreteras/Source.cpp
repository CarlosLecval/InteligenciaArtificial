...
int main()
{
  ...
  do {
    ...
    cout << "4. Monterrey - Cuernavaca (Dirigido)" << endl;
    cout << "5. Lakeview - Chicago (Dirigido)" << endl;
    cout << "6. El Paso - Mexicalli (Dirigido)" << endl;
    cout << "7. Salir" << endl;
    cin >> opcion;
    switch (opcion) {
      case 1:
      ...
      case 3:
        ...
        break;
      case 4:
        r.printRutas("Monterrey", "Cuernavaca", b_grafo_dirigido, true, 20, costo);
        break;
      case 5:

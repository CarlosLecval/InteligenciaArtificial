...
class Busqueda
{
	public:
		...
		bool busqueda_k_beans(string nodo_inicio, string nodo_final, unsigned int k, int& nodo_encontrado);
		bool busqueda_branch_and_bound(string nodo_inicio, string nodo_final, int& nodo_encontrado);
